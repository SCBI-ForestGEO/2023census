...
*Important to include the example of a tropical site. Tropical sites have large lag between data collection and finalization because species ID is needed for new recruits. Also, should have an example of paper data collection.*
